...
export const About = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text>
        Urban Tales es una aplicación única diseñada para los narradores urbanos y exploradores curiosos del mundo
        moderno. Al combinar la narrativa interactiva con la tecnología de geolocalización, esta aplicación permite a
        los usuarios crear y compartir historias ambientadas en ubicaciones específicas en un mapa. Cada relato se
        convierte en una aventura, esperando ser descubierta por otros usuarios que, al visitar esos lugares, pueden
        desbloquear los cuentos y sumergirse en las leyendas que cada esquina de la ciudad tiene para contar.
      </Text>
