...
export const NewTaleIsAnonymous = () => {
  ...
  const navigation = useNavigation<StackNavigationProp<NewTaleStackParamList, 'Anonymous'>>();
  ...
  const handleToggle = () => {
    ...
    else dispatch(updateStringPropertyAsync({ property: 'isAnonymous', value: !newTale.isAnonymous }));
  };

  return (
    <View style={{ backgroundColor: 'white', flex: 1, justifyContent: 'center', paddingHorizontal: 20 }}>
      <ModalPremium isModalVisible={showModalPremium} setModalVisible={setShowModalPremium} />
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={handleToggle}>
          <Animatable.View
            ...
            style={[styles.switch, { backgroundColor: newTale.isAnonymous ? '#ff225f' : '#7b7b7b' }]}>
            <Animatable.View
              transition="translateX"
              style={[styles.circle, newTale.isAnonymous ? styles.circleRight : styles.circleLeft]}
            />
          </Animatable.View>
        </TouchableOpacity>
      </View>
